...
import { alertsAddTag, alertsRemoveTag, casesAddTag, casesRemoveTag } from "@/client"
...
export function AlertActions({
  ...
  item: AlertReadMinimal
  setSelectedAlert: (case_: AlertReadMinimal) => void
}) {
  ...
  return (
    <DropdownMenuGroup>
      ...
      >
        <Link
          href={`/workspaces/${workspaceId}/alerts/${item.id}`}
          target="_blank"
