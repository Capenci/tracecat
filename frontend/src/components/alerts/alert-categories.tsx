...
import { AlertBadgeProps } from "./alert-badge"
...
export const STATUSES: Record<AlertStatus, AlertBadgeProps<AlertStatus>> = {
  unknown: {
    value: "unknown",
    label: "Unknown",
    icon: CircleHelpIcon,
...
export const PRIORITIES: Record<AlertPriority, AlertBadgeProps<AlertPriority>> = {
  unknown: {
    label: "Unknown",
    value: "unknown",
    icon: CircleHelpIcon,
...
export const SEVERITIES: Record<AlertSeverity, AlertBadgeProps<AlertSeverity>> = {
  unknown: {
    label: "Unknown",
    value: "unknown",
    icon: CircleHelpIcon,
