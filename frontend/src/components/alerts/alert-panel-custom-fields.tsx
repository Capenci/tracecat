...
import { z } from "zod"
import type { AlertCustomFieldRead, AlertUpdate } from "@/client"
...
export function CustomField({
  ...
  customField: AlertCustomFieldRead
  updateAlert: (caseUpdate: Partial<AlertUpdate>) => Promise<void>
}) {
  ...
  const onSubmit = async (data: CustomFieldFormSchema) => {
    const alertUpdate: Partial<AlertUpdate> = {
      fields: {
        [customField.id]: data.value,
      },
    }
    console.log("alertUpdate", alertUpdate)
    try {
